...
>(
    (
        ...
        const handleSaveSubgoal = async () => {
            ...
            if (editSubgoal) {
                //Optimistic update Subgoal
                const updatedMetric = {
                    ...metricItem,
                    subgoals: metricItem.subgoals.map(
                        (subgoal: Models.Document) =>
                            subgoal.$id === editSubgoal.$id
                                ? {
                                      ...subgoal,
                                      name: subgoalName,
